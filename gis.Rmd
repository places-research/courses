...
# Competências a serem desenvolvidas {.tabset .tabset-fade .tabset-pills}
...
knitr::include_graphics('./img/pensamento_espacial.png')
```
...
## Sistemas Geodésicos {.tabset .tabset-fade .tabset-pills}

### Geóide   
Forma irregular, com ondulações e depressões

```{r echo=FALSE, out.width='50%'}
knitr::include_graphics('./img/gravidade_terra.png')
```
...
knitr::include_graphics('./img/geoide.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/elipsoi_1.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/elipsoide_2.png')
```

---

### Objetivos dos sistemas geodésicos
...
O Datum é um marco geodésico, horizontal ou vertical, usado como ponto de origem do sistema geodésico (referência)   
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/geoide_geocentrico.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/geoide_topocentrico.png')
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/aW-qbx04gS4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/ecZIluGHOW4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/xKGlMp__jog" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

---

## Sistemas de referências  {.tabset .tabset-fade .tabset-pills}  
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/YW8lwn8L6rA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/AcBlPMGwLdU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/NhUgYgH53l0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

### Sistemas de coordenadas geográficas  {.tabset .tabset-fade .tabset-pills}
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/graus.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/lat_long.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/projecao.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/laranja1.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/laranja 2.png')
```

Representar uma superfície curva (a Terra) em um plano sempre envolve deformações. **Não existe projeção ideal**.     

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/erro_proj1.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/proj.jpg')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/planotangente.png')
```

- Secante

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/planosecante.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/mercartor.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/utm.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/utm_br.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/utm1.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/utm2.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/utm5.png')
```

---

## Sistemas de Informações Geográficas  {.tabset .tabset-fade .tabset-pills}
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('./img/vector-vs-raster.png')
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Km9ZVmZsoDo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
