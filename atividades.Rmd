...
### Atividades do módulo
A atividade de geração de layout será realizada no módulo 12.


## Módulo 11: Geocodificação   
### Material de suporte
...
### Atividades do módulo
1. Geocodificar a base de dados de supermercados [supermercados.xlsx](https://drive.google.com/file/d/1u6XG3WEU1nNCqmQCB3-xhOGmSytZvqWQ/view?usp=sharing)

Essa informação será utilizada na atividade do módulo 12 e seu resultado postado no Canvas. 


## Módulo 12: Mapas temáticos (categóricos e numéricos) 
### Material de suporte
